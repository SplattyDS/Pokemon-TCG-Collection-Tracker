...
$temp = array(array(2707,'h', 'red'),array(2706,'h', 'red'),array(2708,'h', 'red'),array(6810,'h', 'red'),array(6816,'h', 'red'),array(8573,'h', 'red'),array(8499,'h', 'red'),array(11127,'h', 'red'),array(10993,'h', 'red'),array(13542,'h', 'red'),array(3055,'u', 'red'),array(3052,'u', 'red'),array(1918,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(2397,'h', 'red'),array(2383,'h', 'red'),array(2349,'h', 'red'),array(2496,'h', 'red'),array(2505,'h', 'red'),array(2576,'h', 'red'),array(2529,'h', 'red'),array(3856,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(2963,'h', 'red'),array(3310,'h', 'red'),array(4233,'h', 'red'),array(4926,'h', 'red'),array(4881,'h', 'red'),array(6732,'h', 'red'),array(5356,'h', 'red'),array(7888,'h', 'red'),array(5419,'h', 'red'),array(6233,'h', 'red'),array(7438,'h', 'red'),array(7433,'h', 'red'),array(5770,'h', 'red'),array(8098,'h', 'red'),array(8179,'h', 'red'),array(8149,'h', 'red'),array(8448,'h', 'red'),array(324,'u', 'red'),array(3625,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(5336,'h', 'red'),array(8736,'h', 'red'),array(11273,'h', 'red'),array(13971,'h', 'red'),array(2611,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
print('<div id="container - '.$j++.'" class="center">');
print('<h1>Star Holo (Evolutions)</h1>');
foreach ($temp as $cur) { if ($cur[1] == 'u') {acetoneImg($cur[0], $cur[2]);} else {acetoneImgH($cur[0], $cur[2]);} }
print('</div>');

$temp = array(array(8386,'h', 'red'),array(13769,'h', 'red'),array(1072,'u', 'red'),array(1233,'u', 'red'),array(1773,'u', 'red'),array(1775,'u', 'red'),array(1421,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(8652,'h', 'red'),array(8771,'h', 'red'),array(8780,'h', 'red'),array(8975,'h', 'red'),array(8459,'h', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(10786,'h', 'red'),array(11076,'h', 'red'),array(11096,'h', 'red'),array(11051,'h', 'red'),array(13539,'h', 'red'),array(3921,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
print('<h1>Line Holo</h1>');
foreach ($temp as $cur) { if ($cur[1] == 'u') {acetoneImg($cur[0], $cur[2]);} else {acetoneImgH($cur[0], $cur[2]);} }
print('</div>');

$temp = array(array(10819,'h', 'red'),array(11276,'h', 'red'),array(11285,'h', 'red'),array(11463,'h', 'red'),array(11028,'h', 'red'),array(2595,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(672,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
print('<h1>Unknown Holo (XY Silver)</h1>');
foreach ($temp as $cur) { if ($cur[1] == 'u') {acetoneImg($cur[0], $cur[2]);} else {acetoneImgH($cur[0], $cur[2]);} }
print('</div>');
...
$temp = array(array(430,'u', 'red'),array(468,'u', 'red'),array(545,'u', 'red'),array(879,'u', 'red'),array(552,'u', 'red'),array(925,'u', 'red'),array(626,'u', 'red'),array(684,'u', 'red'),array(932,'u', 'red'),array(566,'u', 'red'),array(543,'u', 'red'),array(941,'u', 'red'),array(436,'u', 'red'),array(602,'u', 'red'),array(989,'u', 'red'),array(1012,'u', 'red'),array(1063,'u', 'red'),array(940,'u', 'red'),array(522,'u', 'red'),array(723,'u', 'red'),array(1023,'u', 'red'),array(1055,'u', 'red'),array(709,'u', 'red'),array(935,'u', 'red'),array(917,'u', 'red'),array(791,'u', 'red'),array(671,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(861,'u', 'red'),array(3255,'u', 'red'),array(863,'u', 'red'),array(862,'u', 'red'),array(865,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
...
$temp = array(array(3054,'u', 'red'),array(2493,'u', 'red'),array(2403,'u', 'red'),array(1961,'u', 'red'),array(2066,'u', 'red'),array(2721,'u', 'red'),array(3071,'u', 'red'),array(2314,'u', 'red'),array(2783,'u', 'red'),array(3635,'u', 'red'),array(3371,'u', 'red'),array(2328,'u', 'red'),array(3604,'u', 'red'),array(2836,'u', 'red'),array(3596,'u', 'red'),array(2888,'u', 'red'),array(3353,'u', 'red'),array(3394,'u', 'red'));
print('<div id="container - '.$j++.'" class="center">');
