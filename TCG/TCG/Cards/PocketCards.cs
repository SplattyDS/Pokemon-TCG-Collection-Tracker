...
namespace TCG
{
	public static class PocketCards
	{
		private static PocketCard[] TheCards =
		{
			...
			new PocketCard("Arcanine ex", Pokedex.Arcanine, PocketRarity.ex, Types.Fire, Sets.Genetic_Apex, 41, true),
			...
			new PocketCard("Pikachu ex", Pokedex.Pikachu, PocketRarity.Gold_ex, Types.Lightning, Sets.Genetic_Apex, 285),
			...
			new PocketCard("Beedrill", Pokedex.Beedrill, PocketRarity.Holo, Types.Grass, Sets.Genetic_Apex, 10),
			...
			new PocketCard("Exeggutor", Pokedex.Exeggutor, PocketRarity.Holo, Types.Grass, Sets.Genetic_Apex, 22),
			new PocketCard("Charizard", Pokedex.Charizard, PocketRarity.Holo, Types.Fire, Sets.Genetic_Apex, 35),
			new PocketCard("Arcanine", Pokedex.Arcanine, PocketRarity.Holo, Types.Fire, Sets.Genetic_Apex, 40),
			new PocketCard("Flareon", Pokedex.Flareon, PocketRarity.Holo, Types.Fire, Sets.Genetic_Apex, 45),
			new PocketCard("Moltres", Pokedex.Moltres, PocketRarity.Holo, Types.Fire, Sets.Genetic_Apex, 46),
			new PocketCard("Blastoise", Pokedex.Blastoise, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 55),
			new PocketCard("Poliwrath", Pokedex.Poliwrath, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 61),
			new PocketCard("Gyarados", Pokedex.Gyarados, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 78),
			new PocketCard("Lapras", Pokedex.Lapras, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 79),
			...
			new PocketCard("Articuno", Pokedex.Articuno, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 83),
			new PocketCard("Greninja", Pokedex.Greninja, PocketRarity.Holo, Types.Water, Sets.Genetic_Apex, 89),
			new PocketCard("Raichu", Pokedex.Raichu, PocketRarity.Holo, Types.Lightning, Sets.Genetic_Apex, 95),
			new PocketCard("Magneton", Pokedex.Magneton, PocketRarity.Holo, Types.Lightning, Sets.Genetic_Apex, 98),
			new PocketCard("Jolteon", Pokedex.Jolteon, PocketRarity.Holo, Types.Lightning, Sets.Genetic_Apex, 102),
			new PocketCard("Zapdos", Pokedex.Zapdos, PocketRarity.Holo, Types.Lightning, Sets.Genetic_Apex, 103),
			...
			new PocketCard("Kabutops", Pokedex.Kabutops, PocketRarity.Holo, Types.Fighting, Sets.Genetic_Apex, 159),
			new PocketCard("Nidoqueen", Pokedex.Nidoqueen, PocketRarity.Holo, Types.Darkness, Sets.Genetic_Apex, 168),
			new PocketCard("Nidoking", Pokedex.Nidoking, PocketRarity.Holo, Types.Darkness, Sets.Genetic_Apex, 171),
			new PocketCard("Muk", Pokedex.Muk, PocketRarity.Holo, Types.Darkness, Sets.Genetic_Apex, 175),
			...
			new PocketCard("Dragonite", Pokedex.Dragonite, PocketRarity.Holo, Types.Dragon, Sets.Genetic_Apex, 185),
			new PocketCard("Pidgeot", Pokedex.Pidgeot, PocketRarity.Holo, Types.Colorless, Sets.Genetic_Apex, 188),
			new PocketCard("Kangaskhan", Pokedex.Kangaskhan, PocketRarity.Holo, Types.Colorless, Sets.Genetic_Apex, 203),
