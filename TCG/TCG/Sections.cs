namespace TCG
{
	public static class Sections
	{
		private static Section[] TheSections =
		{
			...
			new Section(Rarity.Full_Art_Pokemon_BWXY_Textured, "Full Art Pokémon (BWXY - Textured)", SortMode.SORT_BY_SET),
			new Section(Rarity.Full_Art_Pokemon_BWXY_Radiant, "Full Art Pokémon (BWXY - Radiant)", SortMode.SORT_BY_SET),
			new Section(Rarity.Full_Art_Pokemon_BWXY_Plasma, "Full Art Pokémon (BWXY - Plasma)", SortMode.SORT_BY_SET),
			new Section(Rarity.Full_Art_Pokemon_BWXY_Legendary, "Full Art Pokémon (BWXY - Legendary)", SortMode.SORT_BY_SET),
			new Section(Rarity.Full_Art_Pokemon_BWXY_Mythical, "Full Art Pokémon (BWXY - Mythical)", SortMode.SORT_BY_SET),
			new Section(Rarity.Full_Art_Pokemon_BWXY_Other, "Full Art Pokémon (BWXY - Other)", SortMode.SORT_BY_SET),
			...
			new Section(Rarity.M_EX_Full_Art_Radiant, "Mega EX Full Art (Radiant)", SortMode.SORT_BY_SET_AND_DEX_AND_TYPE),
