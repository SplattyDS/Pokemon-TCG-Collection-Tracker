namespace TCG
{
	public static class Sections
	{
		private static Section[] TheSections =
		{
			...
			new Section(Rarity.Shiny_Vault_SM, "Shiny Vault (SM)", SortMode.SORT_BY_SET_AND_DEX_AND_TYPE),
			...
			new Section(Rarity.Shiny_Vault_SWSH, "Shiny Vault (SWSH)", SortMode.SORT_BY_SET_AND_DEX_AND_TYPE),
