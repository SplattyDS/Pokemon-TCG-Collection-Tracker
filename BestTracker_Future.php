...
$FUT_AR = array('AR1','AR2','AR3','AR4','AR5','AR6','AR7','AR8','AR9','AR10','AR11','AR12','AR13','AR14','AR15','AR16');
start($j++, 'Ancient Roar (JP)', $have, $FUT_AR);
foreach ($FUT_AR as $cur) { imgF($cur); }
finish();

$FUT_FF = array('FF1','FF2','FF3','FF4','FF5','FF6','FF7','FF8','FF9','FF10','FF11','FF12','FF13','FF14','FF15','FF16');
...
$FUT_All = array('RS1','RS2','RS3','RS4','RS5','RS6','RS7','RS8','RS9','RS10','RS11','RS12','RS13','RS14','RS15','RS16','RS17','RS18','RS19','RS20','RS21','RS22','RS23','RS24','RS25','RS26','RS27','RS28','RS29','RS30','RS31','RS32','RS33','RS34','RS35','RS36','AR1','AR2','AR3','AR4','AR5','AR6','AR7','AR8','AR9','AR10','AR11','AR12','AR13','AR14','AR15','AR16','FF1','FF2','FF3','FF4','FF5','FF6','FF7','FF8','FF9','FF10','FF11','FF12','FF13','FF14','FF15','FF16','SVPEN1','SVPEN2','SVP1','SVP2','SVP3','SVP4','SVP5','SVPCH1','SVPCH2','EXSD1','SST1','SST2','SVG1','SVG2','SVG3','CLV1','CLC1','CLB1');
