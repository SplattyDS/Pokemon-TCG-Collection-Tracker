...
// AlignPage($binder1);
$p = &$Pikachu_Worlds_Collection;
AddCards($binder1, array($p[0],$p[1],$p[2],$p[3],-1,$p[4],$p[5],-1,$p[6],$p[7],$p[8],$p[9]));
AlignPage($binder1);
...
$input = array(11, '/p', 1, '/r', 2, '/p', 2, '/r', 4, '/p', 1, '/r', 3, '/r', 1, '/s', 1, -1, 1, -1, 1, -5, 1, -5, 1, -2, 1, -1, 2, -2, 1, -2, '/p', 9, '/p', 2, '/r', 5, '/p', 6, '/r', 1, '/p', 11, '/p', 3, '/r', 4, '/p', 12, '/r', 1, '/r', 3, '/p', 5, '/r', 1, '/p', 3, '/p', 20, '/r', 1, '/p', 15, 1, '/r', 2, '/r', 2, '/p', 1, 1, -1, 1, '/r', 5, 1, '/p', 21, '/r', 1, '/r', 3, 1, '/r', 3, '/p', 8, '/p', 2, '/r', 2, '/r', 1, '/b', 101, '/s', 8, '/p', 12, '/p', 23, '/p', 3, '/s', '/v', 6, '/v', '/p', 9, '/p', 16, '/r', 3, '/r', -3, 1, '/p', 24, '/p', 7, '/r', 2, -1, 1, '/p', 8, '/p', 4, '/r', 3, '/r', 1, '/p', 4, '/r', 3, '/r', 1, '/p', 14, '/p', 2, -1, 1, '/r', 1, '/r', 1, '/p', 2, '/r', 4, '/p', 1, '/r', 2, '/b', 18, '/p', 4, '/r', 3, '/p', 20, '/r', 4, '/s', 3, '/r', 5, '/r', 2, '/r', 4, '/r', 2, '/r', 2, 1, 1, '/p', 3, 1, 2, '/r', 2, '/p', 1, '/s', 0, '/b');
