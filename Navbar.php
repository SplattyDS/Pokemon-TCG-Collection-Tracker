		...
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					<li><a class="dropdown-item" href="BestTracker.php">Main</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?set">Set</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?col">Collection</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?binder">Binder</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?type">Type</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?dex">Dex</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?all">All</a></li>
					<li><a class="dropdown-item" href="BestTracker.php?fut">Future</a></li>
				</ul>
			</li>
			...
			<li class="nav-item dropdown">
				...
				<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
					<li><a class="dropdown-item" href="BestTracker.php?extremely_rare">Extremely Rare</a></li>
					
					<li><a class="dropdown-item" href="BestTracker.php?date">Date</a></li>
					<!--<li><a class="dropdown-item" href="BestTracker.php?acetone">Acetone</a></li>-->
					<li><a class="dropdown-item" href="BestTracker.php?percent">Percent</a></li>
